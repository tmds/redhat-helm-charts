...
| `build.ref` | Git ref containing the application you want to build | dotnetcore-8.0 | This value defaults to the sample application branch. Be sure to override this if you want to build and deploy your own application. |
